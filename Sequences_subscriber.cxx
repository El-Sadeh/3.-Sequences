...
rtiddsgen -language C++03 -example <arch> Sequences.idl
...
class SequencesReaderListener : public dds::sub::NoOpDataReaderListener<Sequences> {
  public:

    SequencesReaderListener() : count_ (0)
    {
    }

    void on_data_available(dds::sub::DataReader<Sequences>& reader)
    {
        // Take all samples
        dds::sub::LoanedSamples<Sequences> samples = reader.take();

        for ( dds::sub::LoanedSamples<Sequences>::iterator sample_it = samples.begin();
...
void subscriber_main(int domain_id, int sample_count)
{
    ...
    SequencesReaderListener listener;
    dds::sub::DataReader<Sequences> reader(
    ...
    while (listener.count() < sample_count || sample_count == 0) {
        std::cout << "Sequences subscriber sleeping for 4 sec..." << std::endl;
